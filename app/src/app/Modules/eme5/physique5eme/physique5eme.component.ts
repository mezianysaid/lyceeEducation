...
@Component({
  selector: 'app-physique5eme',
  templateUrl: './physique5eme.component.html',
  styleUrls: ['./physique5eme.component.scss']
})
export class Physique5emeComponent implements OnInit {
  categ:any
  lesson='lesson';
Blog='blog';
Td='td';
