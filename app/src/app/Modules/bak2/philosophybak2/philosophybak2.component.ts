...
@Component({
  selector: 'app-philosophybak2',
  templateUrl: './philosophybak2.component.html',
  styleUrls: ['./philosophybak2.component.scss']
})
export class Philosophybak2Component implements OnInit {
 categ?:any
 lesson='lesson';
Blog='blog';
Td='td';
